...
import com.ecommerce.elasticsearch.component.ElacticeService;
import com.ecommerce.elasticsearch.component.ResultData;
import com.ecommerce.elasticsearch.component.ResultSetData;

@Service
public class ProvinceService implements ElacticeService<ProvinceEntity, ProvinceSource> {
    ...
    public ResultSetData<ProvinceEntity> getListSource(ProvinceSource source) {
        String sql = ProviceSql.sqlSearchProvince(source);
